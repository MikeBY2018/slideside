...
$('.nextFrame').click(function() {
    ...
    $('img.fullshine').removeClass('fullshine').parent('div').css('width', '120px').next('div').width(thewidth).contents().addClass('fullshine');
...
$('.prevFrame').click(function() {
    ...
    $('img.fullshine').removeClass('fullshine').parent('div').css('width', '120px').prev('div').width(thewidth).contents().addClass('fullshine');
